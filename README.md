...
- **A sidebar pet** — a kea parrot fed by shipped tasks, grumpy when neglected, asleep before 6am —
  or Rollo, a roller droid that patrols the screen, spins when you ship, and speaks in beeps.
  Click to pat or boop. Renameable, toggleable, entirely local.
